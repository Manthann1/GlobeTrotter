...
const CITIES_DATA = [
  // ═══════════ INDIAN CITIES ═══════════
  {
    ...
    activities: [
      { name: 'Amber Fort & Sheesh Mahal VIP Tour', category: 'Culture & History', cost: 1200, durationMins: 180, description: 'Explore the magnificent Amber Fort complex including the dazzling mirror-work Sheesh Mahal with a private guide.', imageUrl: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&w=800&q=80', rating: 4.90, tags: ['fort', 'heritage', 'guided-tour'] },
      { name: 'Hawa Mahal Sunrise Photography Walk', category: 'Sightseeing', cost: 500, durationMins: 90, description: 'Capture the iconic Palace of Winds at golden hour with a local photography guide through the old city lanes.', imageUrl: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['photography', 'sunrise', 'walking-tour'] },
      { name: 'Chokhi Dhani Royal Rajasthani Thali', category: 'Food & Dining', cost: 1800, durationMins: 150, description: 'Authentic 56-item Rajasthani thali with live folk dance, puppet shows, and camel rides at this cultural village.', imageUrl: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['thali', 'folk-culture', 'dinner'] },
      { name: 'City Palace & Museum Complex', category: 'Culture & History', cost: 700, durationMins: 120, description: 'Tour the royal City Palace complex housing the Maharaja Sawai Man Singh II Museum with textiles, arms, and art.', imageUrl: 'https://images.unsplash.com/photo-1603262110263-fb010d6e59d4?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['palace', 'museum', 'royalty'] },
      { name: 'Nahargarh Fort Sunset & Jaipur Panorama', category: 'Sightseeing', cost: 350, durationMins: 120, description: 'Watch the sunset over the Pink City from the ramparts of Nahargarh Fort perched on the Aravalli hills.', imageUrl: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['sunset', 'panorama', 'fort'] },
      { name: 'Johari Bazaar Gemstone & Textile Walk', category: 'Leisure', cost: 200, durationMins: 120, description: 'Guided walk through the famous jewellery and textile bazaar — learn about Kundan, Meenakari, and block printing.', imageUrl: 'https://images.unsplash.com/photo-1615836245337-f5b9b2303f10?auto=format&fit=crop&w=800&q=80', rating: 4.50, tags: ['shopping', 'bazaar', 'crafts'] },
      { name: 'Samode Haveli Heritage Stay', category: 'Lodging', cost: 8500, durationMins: 1440, description: 'Overnight stay in a 175-year-old restored haveli with courtyard pool, Sheesh Mahal dining, and rooftop yoga.', imageUrl: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=800&q=80', rating: 4.95, tags: ['haveli', 'heritage-stay', 'luxury'] },
    ]
  },
  {
    name: 'Udaipur',
    ...
    activities: [
      { name: 'Lake Pichola Sunset Boat Cruise', category: 'Leisure', cost: 900, durationMins: 90, description: 'Cruise past the Jag Mandir and Taj Lake Palace on shimmering Lake Pichola as the sun sets behind the Aravallis.', imageUrl: 'https://images.unsplash.com/photo-1588096344356-9b2767098485?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['boat-cruise', 'sunset', 'lake'] },
      { name: 'City Palace & Crystal Gallery Tour', category: 'Culture & History', cost: 600, durationMins: 150, description: 'Explore the sprawling City Palace complex and the rare Crystal Gallery with Bohemian crystal furniture and jewels.', imageUrl: 'https://images.unsplash.com/photo-1595815771614-ade9d652a65d?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['palace', 'museum', 'crystal'] },
      { name: 'Ambrai Lakeside Fine Dining', category: 'Food & Dining', cost: 2500, durationMins: 120, description: 'Dine on Rajasthani and continental cuisine at one of India\'s most scenic restaurants overlooking Lake Pichola and the City Palace.', imageUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['lakeside', 'fine-dining', 'romantic'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: 'Fontainhas Latin Quarter Heritage Walk', category: 'Culture & History', cost: 400, durationMins: 120, description: 'Stroll through the colourful Portuguese-era Latin Quarter with tile-roofed houses, churches, and art galleries.', imageUrl: 'https://images.unsplash.com/photo-1580837119756-563d608dd119?auto=format&fit=crop&w=800&q=80', rating: 4.55, tags: ['heritage', 'walking-tour', 'portuguese'] },
      { name: 'Beach Shack Goan Seafood Feast', category: 'Food & Dining', cost: 1200, durationMins: 120, description: 'Feast on prawn balchão, fish recheado, and Goan feni at a beachside bamboo shack on Palolem or Agonda beach.', imageUrl: 'https://images.unsplash.com/photo-1533777857889-4be7c70e33f7?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['seafood', 'beach', 'local-cuisine'] },
      { name: 'Dudhsagar Waterfall Jeep Safari', category: 'Adventure', cost: 2800, durationMins: 360, description: 'Off-road jeep safari through the Western Ghats to the magnificent 310-meter Dudhsagar Falls and a forest swim.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['waterfall', 'safari', 'nature'] },
      { name: 'Basilica of Bom Jesus & Old Goa Churches', category: 'Spiritual', cost: 0, durationMins: 120, description: 'Visit the UNESCO World Heritage Basilica housing the relics of St. Francis Xavier and other 16th-century churches.', imageUrl: 'https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=800&q=80', rating: 4.60, tags: ['church', 'UNESCO', 'heritage'] },
      { name: 'Palolem Beach Kayaking & Dolphin Spotting', category: 'Leisure', cost: 800, durationMins: 90, description: 'Paddle along the crescent-shaped Palolem beach at dawn with chances to spot Indo-Pacific dolphins in the bay.', imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['kayaking', 'dolphins', 'beach'] },
      { name: 'Latin Quarter Heritage Villa Stay', category: 'Lodging', cost: 5500, durationMins: 1440, description: 'Stay in a restored Portuguese villa in Fontainhas with azulejo tiles, courtyard garden, and traditional Goan breakfast.', imageUrl: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['heritage-villa', 'boutique', 'portuguese'] },
    ]
  },
  {
    name: 'Alleppey',
    ...
    activities: [
      { name: 'Overnight Luxury Kettuvallam Houseboat Cruise', category: 'Leisure', cost: 12000, durationMins: 1440, description: 'Drift through the palm-fringed canals of Vembanad Lake in a premium 2-bedroom houseboat with onboard chef and sundeck.', imageUrl: 'https://images.unsplash.com/photo-1593693397690-362cb9666fc2?auto=format&fit=crop&w=800&q=80', rating: 4.90, tags: ['houseboat', 'backwaters', 'luxury'] },
      { name: 'Munnar Tea Estate Walk & Factory Tour', category: 'Sightseeing', cost: 600, durationMins: 180, description: 'Walk through rolling tea plantations in Munnar, visit a working factory, and taste fresh estate-grown varieties.', imageUrl: 'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['tea', 'plantation', 'munnar'] },
      { name: 'Kathakali Classical Dance & Kalaripayattu Show', category: 'Culture & History', cost: 500, durationMins: 120, description: 'Watch the spectacular Kathakali makeup ceremony, dance performance, and a thrilling Kalaripayattu martial arts demonstration.', imageUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['kathakali', 'martial-arts', 'performance'] },
      { name: 'Kerala Sadya Banana-Leaf Feast', category: 'Food & Dining', cost: 450, durationMins: 90, description: 'Traditional 28-course vegetarian feast served on a banana leaf — avial, olan, payasam, and more.', imageUrl: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['sadya', 'vegetarian', 'traditional'] },
      { name: 'Periyar Wildlife Sanctuary Bamboo Rafting', category: 'Adventure', cost: 1500, durationMins: 240, description: 'Bamboo raft through the Periyar Tiger Reserve spotting wild elephants, gaur, and Nilgiri langurs.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['wildlife', 'rafting', 'nature'] },
      { name: 'Ayurvedic Spa & Panchakarma Retreat', category: 'Leisure', cost: 3500, durationMins: 180, description: 'Traditional Kerala Ayurvedic massage, Shirodhara oil therapy, and herbal steam bath at a waterside retreat.', imageUrl: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['ayurveda', 'spa', 'wellness'] },
    ]
  },
  {
    name: 'Varanasi',
    ...
    activities: [
      { name: 'Subah-e-Banaras Sunrise Boat Ride', category: 'Spiritual', cost: 600, durationMins: 90, description: 'Witness the magical sunrise over the Ganges from a rowboat — watch morning rituals, yoga, and cremation ghats.', imageUrl: 'https://images.unsplash.com/photo-1567157577867-05ccb1388e66?auto=format&fit=crop&w=800&q=80', rating: 4.90, tags: ['sunrise', 'boat-ride', 'spiritual'] },
      { name: 'Dashashwamedh Ghat Grand Ganga Aarti', category: 'Spiritual', cost: 0, durationMins: 60, description: 'Experience the spectacular evening fire-and-chant ceremony performed by priests on the main ghat — an unforgettable ritual.', imageUrl: 'https://images.unsplash.com/photo-1571536802807-30451e3955d8?auto=format&fit=crop&w=800&q=80', rating: 4.95, tags: ['ganga-aarti', 'evening', 'ceremony'] },
      { name: 'Kashi Vishwanath Temple & Gali Tour', category: 'Spiritual', cost: 300, durationMins: 120, description: 'Navigate the narrow temple lanes of old Kashi to the revered Vishwanath Temple with a local pandit guide.', imageUrl: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['temple', 'guided-tour', 'old-city'] },
      { name: 'Banarasi Chaat & Street Food Trail', category: 'Food & Dining', cost: 350, durationMins: 120, description: 'Taste legendary kachori-sabzi, tamatar chaat, thandai, and malaiyo at the iconic street food stalls of Varanasi.', imageUrl: 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['street-food', 'chaat', 'food-walk'] },
      { name: 'Sarnath Buddhist Heritage Excursion', category: 'Culture & History', cost: 400, durationMins: 180, description: 'Visit Sarnath where Buddha gave his first sermon — see the Dhamek Stupa, Ashoka Pillar, and archaeological museum.', imageUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', rating: 4.60, tags: ['buddhism', 'stupa', 'heritage'] },
      { name: 'Banarasi Silk Weaving Workshop', category: 'Culture & History', cost: 800, durationMins: 120, description: 'Visit a family-run silk workshop to see the painstaking hand-loom process of creating a Banarasi silk sari.', imageUrl: 'https://images.unsplash.com/photo-1615836245337-f5b9b2303f10?auto=format&fit=crop&w=800&q=80', rating: 4.55, tags: ['silk', 'weaving', 'crafts'] },
    ]
  },
  {
    name: 'Leh',
    ...
    activities: [
      ...
      { name: 'Nubra Valley & Diskit Monastery', category: 'Culture & History', cost: 3500, durationMins: 720, description: 'Cross the world\'s highest motorable pass Khardung La to explore the sand dunes and 32-meter Maitreya Buddha of Nubra.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['monastery', 'khardung-la', 'desert'] },
      ...
      { name: 'Zanskar River Rafting', category: 'Adventure', cost: 3000, durationMins: 300, description: 'White-water rafting through the dramatic Zanskar Gorge — Grade III-IV rapids with towering canyon walls.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['rafting', 'white-water', 'canyon'] },
    ]
  },
  {
    name: 'Manali',
    ...
    activities: [
      { name: 'Rohtang Pass Snow Adventure', category: 'Adventure', cost: 2500, durationMins: 360, description: 'Drive to Rohtang Pass (3,978m) for snowfall views, paragliding, and snowmobile rides amidst the Greater Himalayas.', imageUrl: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['snow', 'paragliding', 'high-pass'] },
      { name: 'Solang Valley Paragliding', category: 'Adventure', cost: 1800, durationMins: 60, description: 'Tandem paragliding flight over Solang Valley with stunning views of Himalayan peaks and the Beas River.', imageUrl: 'https://images.unsplash.com/photo-1586375300773-8384e3e4916f?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['paragliding', 'valley', 'aerial'] },
      { name: 'Old Manali Café Hopping & Hippie Trail', category: 'Leisure', cost: 300, durationMins: 180, description: 'Explore the bohemian cafés, bakeries, and handicraft shops of Old Manali village along the Manalsu stream.', imageUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80', rating: 4.50, tags: ['cafes', 'old-town', 'bohemian'] },
      { name: 'Hadimba Devi Temple & Cedar Forest Walk', category: 'Spiritual', cost: 0, durationMins: 90, description: 'Visit the 1553 pagoda-style Hadimba Temple set in a serene deodar cedar forest — a Mahabharata heritage site.', imageUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', rating: 4.60, tags: ['temple', 'cedar-forest', 'mythology'] },
      { name: 'Beas River Rafting & Camping', category: 'Adventure', cost: 1200, durationMins: 240, description: 'White-water rafting on the Beas River followed by riverside bonfire camping under the stars.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['rafting', 'camping', 'bonfire'] },
  ...
  },
  {
    ...
    activities: [
      { name: 'Gateway of India & Elephanta Caves Ferry', category: 'Culture & History', cost: 600, durationMins: 300, description: 'Take the harbour ferry from the iconic Gateway to the UNESCO Elephanta Caves with 6th-century Shiva sculptures.', imageUrl: 'https://images.unsplash.com/photo-1566552881560-0be862a7c445?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['gateway', 'caves', 'UNESCO'] },
      { name: 'Mumbai Street Food Trail — Chowpatty to Mohammed Ali Road', category: 'Food & Dining', cost: 500, durationMins: 180, description: 'Taste vada pav, pav bhaji, bhel puri, kebabs, and malpua on a guided crawl through Mumbai\'s iconic food streets.', imageUrl: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['street-food', 'vada-pav', 'food-walk'] },
      { name: 'Dharavi Creative Economy Walking Tour', category: 'Culture & History', cost: 800, durationMins: 150, description: 'Respectful tour of Dharavi\'s $1B informal economy — leather, pottery, recycling, and textile workshops.', imageUrl: 'https://images.unsplash.com/photo-1580837119756-563d608dd119?auto=format&fit=crop&w=800&q=80', rating: 4.50, tags: ['walking-tour', 'social-enterprise', 'workshops'] },
      { name: 'Marine Drive Sunset & Art Deco Walk', category: 'Sightseeing', cost: 0, durationMins: 90, description: 'Stroll along the Queen\'s Necklace at sunset, admiring Mumbai\'s UNESCO Art Deco ensemble along Marine Drive.', imageUrl: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['sunset', 'art-deco', 'promenade'] },
      { name: 'Bollywood Studio Tour & Dance Workshop', category: 'Leisure', cost: 1500, durationMins: 240, description: 'Behind-the-scenes tour of Film City sets followed by a Bollywood dance lesson with a choreographer.', imageUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', rating: 4.55, tags: ['bollywood', 'studio', 'dance'] },
      { name: 'Taj Mahal Palace Heritage Stay', category: 'Lodging', cost: 25000, durationMins: 1440, description: 'Iconic 1903 palace hotel overlooking the Gateway of India — opulent rooms, sea-facing suites, and legendary hospitality.', imageUrl: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=800&q=80', rating: 4.95, tags: ['palace-hotel', 'heritage', 'luxury'] },
    ]
  },
  {
    name: 'Delhi',
    ...
    activities: [
      ...
      { name: 'Chandni Chowk Paranthe Wali Gali Food Walk', category: 'Food & Dining', cost: 400, durationMins: 120, description: 'Legendary stuffed parantha lane, chole bhature, jalebi, and rabri at the 150-year-old shops of Old Delhi.', imageUrl: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['street-food', 'parantha', 'old-delhi'] },
      { name: 'Humayun\'s Tomb & Nizamuddin Qawwali', category: 'Spiritual', cost: 600, durationMins: 180, description: 'Visit the magnificent Mughal-era Humayun\'s Tomb, then attend a soul-stirring Sufi Qawwali at Nizamuddin Dargah.', imageUrl: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['mughal', 'qawwali', 'sufi'] },
  ...
  },
  {
    ...
    activities: [
      { name: 'Ganges White-Water Rafting (16km)', category: 'Adventure', cost: 1200, durationMins: 180, description: 'Raft 16km of Grade III–IV rapids on the Ganges from Shivpuri to Rishikesh with cliff jumping stops.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['rafting', 'white-water', 'ganges'] },
      { name: 'Laxman Jhula & Trimbakeshwar Temple Walk', category: 'Spiritual', cost: 0, durationMins: 120, description: 'Cross the iconic suspension bridge and visit the 13-storey Trimbakeshwar temple complex on the east bank.', imageUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', rating: 4.55, tags: ['suspension-bridge', 'temple', 'walking'] },
      { name: 'Beatles Ashram (Chaurasi Kutia) Art Walk', category: 'Culture & History', cost: 150, durationMins: 120, description: 'Explore the abandoned ashram where The Beatles wrote the White Album — now a graffiti art gallery in the forest.', imageUrl: 'https://images.unsplash.com/photo-1580837119756-563d608dd119?auto=format&fit=crop&w=800&q=80', rating: 4.60, tags: ['beatles', 'ashram', 'art'] },
      { name: 'Sunrise Yoga & Meditation Session', category: 'Spiritual', cost: 500, durationMins: 90, description: 'Join a traditional Hatha Yoga and guided meditation session at a Ganges-side ashram with Himalayan views.', imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['yoga', 'meditation', 'sunrise'] },
      { name: 'Bungee Jumping at Jumpin Heights', category: 'Adventure', cost: 3550, durationMins: 60, description: 'India\'s highest bungee jump — 83 metres over a rocky ravine, operated by New Zealand jump masters.', imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['bungee', 'extreme', 'adventure'] },
      { name: 'Triveni Ghat Evening Aarti', category: 'Spiritual', cost: 0, durationMins: 45, description: 'Attend the serene evening Ganga Aarti at Triveni Ghat where three sacred rivers meet — a gentle Himalayan ritual.', imageUrl: 'https://images.unsplash.com/photo-1571536802807-30451e3955d8?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['ganga-aarti', 'evening', 'spiritual'] },
    ]
  },
  ...
  // ═══════════ INTERNATIONAL CITIES ═══════════
  {
    ...
    activities: [
      ...
      { name: 'Seine River Sunset Dinner Cruise', category: 'Food & Dining', cost: 7200, durationMins: 120, description: 'Enjoy a 3-course French dinner while cruising past illuminated Parisian monuments at twilight.', imageUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['seine', 'dinner-cruise', 'romantic'] },
      { name: 'Montmartre & Sacré-Cœur Walking Tour', category: 'Sightseeing', cost: 1700, durationMins: 120, description: 'Stroll through bohemian Montmartre, visit the artists\' square at Place du Tertre, and enter Sacré-Cœur.', imageUrl: 'https://images.unsplash.com/photo-1509299349698-dd22323b5963?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['montmartre', 'walking-tour', 'bohemian'] },
      ...
      { name: 'Palace of Versailles Day Trip', category: 'Culture & History', cost: 4600, durationMins: 360, description: 'Tour the Hall of Mirrors, Grand Apartments, and magnificent Royal Gardens of Versailles.', imageUrl: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['versailles', 'palace', 'day-trip'] },
    ]
  },
  {
    name: 'Tokyo',
    ...
    activities: [
      { name: 'Senso-ji Temple & Asakusa Traditional Walk', category: 'Culture & History', cost: 0, durationMins: 120, description: 'Visit Tokyo\'s oldest Buddhist temple and browse traditional craft shops along the Nakamise shopping street.', imageUrl: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['temple', 'asakusa', 'traditional'] },
      { name: 'Shibuya Crossing & Harajuku Pop-Culture Safari', category: 'Sightseeing', cost: 0, durationMins: 180, description: 'Experience the world\'s busiest pedestrian crossing then explore Harajuku\'s Takeshita Street fashion scene.', imageUrl: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=800&q=80', rating: 4.70, tags: ['shibuya', 'harajuku', 'pop-culture'] },
      { name: 'Tsukiji Outer Market Sushi Masterclass', category: 'Food & Dining', cost: 6500, durationMins: 150, description: 'Learn to make nigiri and maki sushi with a master sushi chef at the legendary Tsukiji Outer Market.', imageUrl: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80', rating: 4.90, tags: ['sushi', 'cooking-class', 'tsukiji'] },
      { name: 'TeamLab Borderless Digital Art Museum', category: 'Leisure', cost: 2800, durationMins: 120, description: 'Immersive, boundary-less digital art installations where you walk through flowing water, flowers, and light.', imageUrl: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['teamlab', 'digital-art', 'immersive'] },
      ...
      { name: 'Golden Gai Bar Hopping Experience', category: 'Food & Dining', cost: 3000, durationMins: 150, description: 'Explore the 200+ tiny bars of Shinjuku Golden Gai with a local guide — each seats just 6-8 people.', imageUrl: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['nightlife', 'bars', 'shinjuku'] },
    ]
  },
  {
    name: 'Rome',
    ...
    activities: [
      ...
      { name: 'Trastevere Food & Wine Walking Tour', category: 'Food & Dining', cost: 4200, durationMins: 180, description: 'Taste authentic Roman cuisine — supplì, cacio e pepe, porchetta, and local wines in the charming Trastevere quarter.', imageUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['food-tour', 'wine', 'trastevere'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: 'Uluwatu Temple Sunset & Kecak Fire Dance', category: 'Culture & History', cost: 600, durationMins: 150, description: 'Watch the sunset from the cliff-top Uluwatu Temple, then enjoy the mesmerising Kecak fire dance performance.', imageUrl: 'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['temple', 'sunset', 'kecak'] },
      { name: 'Mount Batur Sunrise Trek', category: 'Adventure', cost: 2500, durationMins: 360, description: 'Pre-dawn hike to the summit of active volcano Mount Batur for an unforgettable sunrise above the clouds.', imageUrl: 'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?auto=format&fit=crop&w=800&q=80', rating: 4.80, tags: ['volcano', 'trekking', 'sunrise'] },
      { name: 'Ubud Monkey Forest & Art Market', category: 'Leisure', cost: 400, durationMins: 120, description: 'Visit the Sacred Monkey Forest Sanctuary and browse the vibrant Ubud Art Market for batik and wood carvings.', imageUrl: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=800&q=80', rating: 4.60, tags: ['monkey-forest', 'art-market', 'ubud'] },
      { name: 'Balinese Cooking Class & Jimbaran Seafood', category: 'Food & Dining', cost: 1500, durationMins: 240, description: 'Learn to cook satay, nasi goreng, and lawar in a family compound, then feast on grilled seafood at Jimbaran Bay.', imageUrl: 'https://images.unsplash.com/photo-1533777857889-4be7c70e33f7?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['cooking-class', 'seafood', 'jimbaran'] },
      { name: 'Spa & Flower Bath Wellness Retreat', category: 'Leisure', cost: 2000, durationMins: 180, description: 'Traditional Balinese massage, body scrub, and iconic flower petal bath in a jungle-set wellness retreat.', imageUrl: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['spa', 'wellness', 'flower-bath'] },
    ]
  },
  {
    name: 'Dubai',
    ...
    activities: [
      ...
      { name: 'Desert Safari — Dune Bashing, BBQ & Belly Dance', category: 'Adventure', cost: 4000, durationMins: 360, description: 'SUV dune bashing, camel rides, sandboarding, henna art, BBQ dinner, and traditional belly dance under the stars.', imageUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=800&q=80', rating: 4.75, tags: ['desert', 'safari', 'BBQ'] },
      { name: 'Dubai Mall & Dubai Fountain Show', category: 'Leisure', cost: 0, durationMins: 180, description: 'Explore the world\'s largest mall, visit the aquarium and ice rink, and watch the spectacular Dubai Fountain at night.', imageUrl: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=800&q=80', rating: 4.65, tags: ['mall', 'fountain', 'shopping'] },
      { name: 'Old Dubai Heritage Tour — Al Fahidi & Souks', category: 'Culture & History', cost: 600, durationMins: 150, description: 'Explore the Al Fahidi Historical District, take an abra across Dubai Creek, and bargain in the Gold and Spice Souks.', imageUrl: 'https://images.unsplash.com/photo-1580837119756-563d608dd119?auto=format&fit=crop&w=800&q=80', rating: 4.55, tags: ['heritage', 'souks', 'old-dubai'] },
      { name: 'Palm Jumeirah Yacht Sunset Cruise', category: 'Leisure', cost: 8000, durationMins: 120, description: 'Private yacht cruise around Palm Jumeirah and the Dubai Marina skyline with canapés and sunset views.', imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80', rating: 4.85, tags: ['yacht', 'sunset', 'luxury'] },
    ]
  },
];
